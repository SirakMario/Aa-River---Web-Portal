...
DEM_2024_legend.onAdd = function (mapL1) {
  var div = L.DomUtil.create('div', 'info legend');
      div.innerHTML +=
      '<img src="http://10.6.4.12:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=UAV_Project:DEM_24" alt="legend" width="70" height="150">';
  return div;
  };
...
Hillshade_24_legend.onAdd = function (mapL3) {
  var div = L.DomUtil.create('div', 'info legend');
      div.innerHTML +=
      '<img src="http://10.6.4.12:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=UAV_Project:Hillshade_24" alt="legend" width="70" height="100">';
  return div;
  };
...
Slope_24_legend.onAdd = function (mapL3) {
  var div = L.DomUtil.create('div', 'info legend');
      div.innerHTML +=
      '<img src="http://10.6.4.12:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=UAV_Project:Slope_24" alt="legend" width="70" height="100">';
      return div;
  };
